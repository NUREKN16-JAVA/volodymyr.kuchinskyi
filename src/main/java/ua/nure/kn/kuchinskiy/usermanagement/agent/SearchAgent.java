package ua.nure.kn.kuchinskiy.usermanagement.agent;
...
import ua.nure.kn.kuchinskiy.usermanagement.agent.gui.SearchGui;
...
public class SearchAgent extends Agent {
    ...
    public void search(String firstName, String lastName) throws SearchException {
        try {
            ...
            Collection<User> users = manageUser.find(firstName, lastName);
            if (users.size() > 0) {
                showUsers(users);
            } else {
