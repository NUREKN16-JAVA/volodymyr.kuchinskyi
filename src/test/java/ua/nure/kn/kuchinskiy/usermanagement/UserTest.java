...
public class UserTest {
    ...
    @Test public void testGetAgeForCurrentYearBirth() {
    ...
    @Test public void testGetAgeYearAgo() {
    ...
    @Test public void testGetAgeMonthBefore() {
    ...
    @Test public void testGetAgeInYearAfter() {
    ...
    // In case if birthday was year after YEAR_OF_BIRTH constant
    @Test public void testGetAgeInYearBefore() {
        LocalDate dateOfBirth = LocalDate.of(YEAR_OF_BIRTH - 1, MONTH_OF_BIRTH, DAY_OF_BIRTH);
        user.setDateOfBirth(dateOfBirth);
        assertEquals(AGE + 1, user.getAge());
    }
